...
import (
	...
	vpp_gtpu "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/gtpu"
	vpp_interfaces "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/interface"
	...
	vpp_ipip "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/ipip"
...
func TestDumpInterfacesTap2(t *testing.T) {
	...
	hwAddr1Parse, err := vpp2310.ParseMAC("01:23:45:67:89:ab")
	Expect(err).To(BeNil())
