...
import (
	...
	vpp_fp "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/flowprobe"
	vpp_ipfix "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/ipfix_export"
...
func init() {
	...
	vppcalls.AddIpfixHandlerVersion(vpp2310.Version, msgs, NewIpfixVppHandler)
}
