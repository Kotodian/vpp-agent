...
import (
	...
	ifvpp2310 "go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/vppcalls/vpp2310"
...
func routeTestSetup(t *testing.T) (*vppmock.TestCtx, ifvppcalls.InterfaceVppAPI, vppcalls.RouteVppAPI) {
	...
	ifHandler := ifvpp2310.NewInterfaceVppHandler(ctx.MockVPPClient, log)
	...
	rtHandler := vpp2310.NewRouteVppHandler(ctx.MockChannel, ifIndexes, vrfIndexes, netallock_mock.NewMockNetAlloc(), log)
