...
import (
	...
	vpe_vpp2310 "go.ligato.io/vpp-agent/v3/plugins/govppmux/vppcalls/vpp2310"
	"go.ligato.io/vpp-agent/v3/plugins/netalloc"
	"go.ligato.io/vpp-agent/v3/plugins/vpp"
	vpp2310 "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310"
	...
	vpp_ip_neighbor "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/ip_neighbor"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/ip_types"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/l3xc"
	vpp_vpe "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2310/vpe"
...
func init() {
	...
	vppcalls.AddHandlerVersion(vpp2310.Version, msgs, NewL3VppHandler)
}
...
func NewIPNeighVppHandler(c vpp.Client, callsChan govppapi.Channel, log logging.Logger) *IPNeighHandler {
	...
	return &IPNeighHandler{
		callsChannel: callsChan,
		log:          log,
		VppCoreAPI:   vpe_vpp2310.NewVpeHandler(c),
	}
}
