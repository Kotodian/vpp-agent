...
import (
	...
	vpp2310 "go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls/vpp2310"
...
func puntTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.PuntVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	puntHandler := vpp2310.NewPuntVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
